...
# Initial values 
inits <- function(){list(mean.phiDB = runif(4, 0.0001, 0.999), mean.phiJB = runif(4, 0.0001, 0.999), mean.phiMI = runif(4, 0.0001, 0.999),
                         mean.phiCC = runif(4, 0.0001, 0.999), mean.phiSE = runif(4, 0.0001, 0.999), mean.phiBR = runif(4, 0.0001, 0.999), mean.phiAR = runif(4, 0.0001, 0.999),
                         mean.pDB = runif(4, 0.0001, 0.999), mean.pJB = runif(4, 0.0001, 0.999), mean.pMI = runif(4, 0.0001, 0.999),
                         mean.pCC = runif(4, 0.0001, 0.999), mean.pSE = runif(4, 0.0001, 0.999), mean.pBR = runif(4, 0.0001, 0.999), mean.pAR = runif(4, 0.0001, 0.999))}  
