...
saveRDS(sim.marr$summary, file = paste0("./analysis-output/debugging/multistate-debugging1-summary", Sys.Date(), ".rds"))

saveRDS(sim.marr$sims.list, file = paste0("./analysis-output/debugging/multistate-debugging1-simslist", Sys.Date(), ".rds"))

# parameter identifiability checks
sims.list <- readRDS("./analysis-output/debugging/multistate-debugging1-simslist2021-10-21.rds")
...
for (i in colnames(sims.list)){
  ...
  png(filename = paste0("analysis-output/parameter-identifiability/debugging1/",
                        i,"-","check.png"),
...
png(filename = "figures/debugging/multistate-debugging1.ppcheck.png", width = 8, height = 6,
    units = "in", res = 600)
...
# plot all
# survival
png(filename = "figures/debugging/debugging1/phiDB.png", width = 8, height = 8,
    units = "in", res = 600)
...
png(filename = "figures/debugging/debugging1/phiJB.png", width = 8, height = 8,
    units = "in", res = 600)
...
png(filename = "figures/debugging/debugging1/phiMI.png", width = 8, height = 8,
    units = "in", res = 600)
...
png(filename = "figures/debugging/debugging1/phiCC.png", width = 8, height = 8,
    units = "in", res = 600)
...
png(filename = "figures/debugging/debugging1/phiSE.png", width = 8, height = 8,
    units = "in", res = 600)
...
png(filename = "figures/debugging/debugging1/phiBR.png", width = 8, height = 8,
    units = "in", res = 600)
...
png(filename = "figures/debugging/debugging1/phiAR.png", width = 8, height = 8,
    units = "in", res = 600)
...
# resighting
png(filename = "figures/debugging/debugging1/pDB.png", width = 8, height = 8,
    units = "in", res = 600)
...
png(filename = "figures/debugging/debugging1/pJB.png", width = 8, height = 8,
    units = "in", res = 600)
...
png(filename = "figures/debugging/debugging1/pMI.png", width = 8, height = 8,
    units = "in", res = 600)
...
png(filename = "figures/debugging/debugging1/pCC.png", width = 8, height = 8,
    units = "in", res = 600)
...
png(filename = "figures/debugging/debugging1/pSE.png", width = 8, height = 8,
    units = "in", res = 600)
...
png(filename = "figures/debugging/debugging1/pBR.png", width = 8, height = 8,
    units = "in", res = 600)
...
png(filename = "figures/debugging/debugging1/pAR.png", width = 8, height = 8,
    units = "in", res = 600)
...
# transition
png(filename = "figures/debugging/debugging1/psiDB.png", width = 8, height = 8,
    units = "in", res = 600)
...
png(filename = "figures/debugging/debugging1/psiJB.png", width = 8, height = 8,
    units = "in", res = 600)
...
png(filename = "figures/debugging/debugging1/psiMI.png", width = 8, height = 8,
    units = "in", res = 600)
...
png(filename = "figures/debugging/debugging1/psiCC.png", width = 8, height = 8,
    units = "in", res = 600)
...
png(filename = "figures/debugging/debugging1/psiSE.png", width = 8, height = 8,
    units = "in", res = 600)
...
png(filename = "figures/debugging/debugging1/psiBR.png", width = 8, height = 8,
    units = "in", res = 600)
...
png(filename = "figures/debugging/debugging1/psiAR.png", width = 8, height = 8,
    units = "in", res = 600)
